...
type Adapter interface {
	...
	// object it created.
	Create(ctx context.Context, c clients.SigNoz, obj Object) (*v1alpha1.ResourceMetadata, error)

	// Find resolves the object's identity to the metadata of matching objects:
	// zero, one, or more than one.
	Find(ctx context.Context, c clients.SigNoz, obj Object) ([]*v1alpha1.ResourceMetadata, error)
	...
	Observe(ctx context.Context, c clients.SigNoz, obj Object, resourceMetadata *v1alpha1.ResourceMetadata) (found bool, upToDate bool, err error)

	// Update applies desired state to the object identified by resourceMetadata.
	Update(ctx context.Context, c clients.SigNoz, resourceMetadata *v1alpha1.ResourceMetadata, obj Object) error

	// Delete removes the object identified by resourceMetadata. An object
	// already gone is not an error.
	Delete(ctx context.Context, c clients.SigNoz, resourceMetadata *v1alpha1.ResourceMetadata) error
}
